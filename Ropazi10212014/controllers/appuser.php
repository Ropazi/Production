		...
		public function signupfbpost()
		{
			...
			try
			{
				...
				if ($appUser->getAppUserID() > 0){
					/*$_AppUser->setCreateDate($appUser->getCreateDate());
					$_AppUser->setLastLogin(new DateTime());
					$_AppUser->setLastUpdateDate($appUser->getLastUpdateDate());
					$_AppUser->setSource($appUser->getSource());
					$_AppUser->setEmailVerified($appUser->getEmailVerified());
					$_AppUser->setUserType($appUser->getUserType());
