...
<div style="position:absolute;background:white;height:450px;width:300px;-webkit-border-radius: 10;-moz-border-radius:10;border-radius: 10px;">
	<form id="signupEditForm" action="<?php echo Constants::$BASEPATH ?>appuser/signuppost" method="post">
		...
		<a href="http://www.ropazi.com/privacypolicy" style="color: gray">Privacy Policy</a>
		<!-- Have an account? Login <a href="#" class="blue">here</a>--> <br/>
		</div>
