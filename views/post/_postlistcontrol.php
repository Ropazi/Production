                ...
                <div class="outercontainer">
                    <div class="content-large-image container-position">
                        ...
                        <div class="content-image">
                            <img class="content-picture" src="https://s3-us-west-2.amazonaws.com/ropazi-product-images/uploads/<?php echo $post->getLocalImageUrl() ?>" />
                        </div>
                    </div>
                    <div class="content-price-panel" >
                        <a class="large-8 small-8 columns price-9 no-padding">
                            <div class="padding-inner" id="div-price<?php echo $i?>">
                                ...
                                <span class="price" style="cursor:pointer;" onclick="javascript:window.open('<?php 
                                	echo "http://go.ropazi.com/?id=72676X1521695&xs=1&url=" . urlencode($post->getPostURL()) . 
										 "&sref=http%3A%2F%2Fbeta.ropazi.com%2F"?>');event.stopPropagation();return false;"><?php echo sprintf("$%.0d", $post->getPrice())?><span class="buy">&nbsp;&nbsp;Buy</span></span>
                            </div>
                        </a>
                    ...
                    <div id="user-panel<?php echo $i?>" class="content-clipping-panel" style="cursor:pointer;" onclick="javascript:location.href='/appuser/userclipping/<?php echo $post->getPosterAppUserID() ?>';event.stopPropagation();return false;">
                        <div class=" large-2 small-4 columns" style="padding-left: 5px;">
                        			<?php if (strlen($post->getUserProfileImage()) > 0) {
				                		echo '<img src="https://s3-us-west-2.amazonaws.com/ropazi-product-images/uploads/users/' . $post->getUserProfileImage() . '_small.jpg" height="25" width="25" />';
				                	} else {
